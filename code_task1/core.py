...
try:
    from loss import (
        ...
        BoundaryFragmentV3CoreRecallRidgeBinaryBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeCandidateBinaryBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeCandidateMassCapBinaryBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeCandidateLogitRidgeBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeCandidateLogitRidgePrecisionBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeCandidateSoftRidgeBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeCandidateSoftRidgeContrastBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateBinaryBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateBarrierContrastHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreCompactSparseSeedHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreCompactSeedHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreCompactBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreRecallBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreCoverageGuardedBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreCoverageOpenBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateBalancedContactBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025ContactPreservePeakCompactBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025MidPeakContactCapCompactBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025MidPeakConservativeCoreTailCompactBarrierHeadLoss,
        ...
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025MidPeakSupportSeedCompactBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025OriginalContactMidPeakCompactBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakContactShellContrastBarrierHeadLoss,
        BoundaryFragmentV3Core025StrongPeakDecoderContactHeadLoss,
        ...
        BoundaryFragmentV3Core025StrongPeakMutex13SeedStableSupportLeakGuardSeedHealedHeadLoss,
        ...
        BoundaryFragmentV3Core025StrongPeakNoContactPairwiseSoftmaxSeedCalibratedV274HeadLoss,
        BoundaryFragmentV3Core025StrongPeakNoContactFragmentPositionV275HeadLoss,
        BoundaryFragmentV3Core025StrongPeakNoContactFragmentPositionDiceV276HeadLoss,
        BoundaryFragmentV3Core025StrongPeakNoContactSeparatorGapV277HeadLoss,
        BoundaryFragmentV3Core025StrongPeakNoContactSeparatorEnergyV278HeadLoss,
        BoundaryFragmentV3Core025StrongPeakNoContactSeparatorSoftmaxV287HeadLoss,
        ...
        BoundaryFragmentV3Core025StrongPeakNoContactABBCSDFFDMV290HeadLoss,
        ...
        BoundaryFragmentV3Core025StrongPeakNoContactCoordSpatialEmbeddingV279HeadLoss,
        BoundaryFragmentV3Core025StrongPeakNoContactQueryMaskV280HeadLoss,
        BoundaryFragmentV3Core025StrongPeakNoContactFreeEmbeddingV282HeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakPrecisionSoftContactRidgeBarrierHeadLoss,
        ...
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakStrongContactShellContrastBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakTightBalancedContactBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025MidPeakTightContactCapCompactBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025WeakPeakCompactBarrierHeadLoss,
        ...
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateInstanceCoreStrongGuardBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateLooseFragmentMassCoreBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateMassCapBarrierHeadLoss,
        ...
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateWeakFragmentMassCoreBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeDenseCandidateWeakMassCapBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeLoss,
        BoundaryFragmentV3CoreRecallRidgeSoftDenseCandidateBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeSoftDenseCandidateBarrierContrastHeadLoss,
        BoundaryFragmentV3CoreRecallRidgeLogitCalibratedLoss,
        BoundaryFragmentV3CoreRecallRidgeMassCapLoss,
        BoundaryFragmentV3CoreRecallRidgePrecisionBinaryBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgePrecisionLogitCalibratedLoss,
        BoundaryFragmentV3CoreRecallRidgePositiveFloorBinaryBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgePositiveFloorMassCapBinaryBarrierHeadLoss,
        BoundaryFragmentV3CoreRecallRidgePositiveMassCapLoss,
        BoundaryFragmentV3CoreRecallRidgeShellContrastLogitCalibratedLoss,
        BoundaryFragmentV3CoreRecallRidgeSoftPositiveMassCapLoss,
        BoundaryFragmentV3CoreRecallRidgeStrongShellContrastLogitCalibratedLoss,
        BoundaryFragmentV3CoreRecallRidgeTightMassCapLoss,
        BoundaryFragmentV3CoreRecallRidgeVerySoftPositiveMassCapLoss,
        BoundaryFragmentV3CoreRidgeLoss,
        BoundaryFragmentV3CoreSeedLoss,
        BoundaryFragmentV3RidgeFitDeepSupervisionWrapper,
        BoundaryFragmentV3RidgeFitLoss,
        BoundaryFragmentV3RidgeFitPrecisionLoss,
        ...
        BICMV68SemanticTopologyLoss,
        BICMV69TopologyCalibratedLoss,
        BICMV70TopologyConsistencyLoss,
        BICMV71EdgeCutPrimaryLoss,
        BICMV73InstanceTopologyLoss,
        BICMV74AdaptiveInstanceTopologyLoss,
        BICMV75EdgePrecisionSeedTopologyLoss,
        BICMV76GentleEdgePrecisionLoss,
        BICMV77EdgeRecallPrecisionCurriculumLoss,
        BICMV78CoreAnchoredEdgeCurriculumLoss,
        BICMV79DuplicateSeedSuppressedEdgeLoss,
        BICMV80TopologyStateAdaptiveLoss,
        BICMV81CoreStableEdgePrecisionLoss,
        BICMV82SeedRecallEdgeSeparationLoss,
        BICMV83SeedSafeEdgeCalibrationLoss,
        BICMV84DualHeadContactCalibrationLoss,
        BICMV85SemanticGateContactLoss,
        BICMV86EvalBandEdgePrimaryLoss,
        BICMV87EvalBandSemanticGateLoss,
        BICMV88CorePreservingBandPrecisionLoss,
        BICMV89BandFalseOnlyEdgePrecisionLoss,
        BICMV90SemanticBandProductLoss,
        BICMV91TopologyAwareEdgeBalanceLoss,
        BICMV93EvalAlignedSupportContactLoss,
        BICMV94FinalRowSupportContactLoss,
        BICMV95DecoderFeatureContactSeparationLoss,
        BICMV96DenseBandGateLoss,
        BICMV97PositiveDenseBandGateLoss,
        BICMV98TeacherDistilledDenseGateLoss,
        BICMV99AdaptiveDualMarginDenseGateLoss,
        BICMV101DualFieldProductGateLoss,
        BICMV102DistanceRankDenseGateLoss,
        BICMV103SemanticDistanceContactLoss,
        BICMV104TeacherDistilledSemanticContactLoss,
        BICMV105OffsetAssignmentLoss,
        BICMV106OffsetAttractorLoss,
        BICMV107RadialSupportOffsetLoss,
        BICMV108WatershedBarrierLoss,
        BICMV109PrecisionLockedRecallLoss,
        BICMV110SemanticGeometryBridgeLoss,
        BICMV111JointSupportProductLoss,
        BICMV112EdgeGraphAssignmentLoss,
        BICMV113AdaptiveBoundaryProductLoss,
        BICMV115SemanticOracleAdapterLoss,
        BICMV116GraphCostSeparatorLoss,
        BICMV117SupportGateSemanticContactLoss,
        BICMV118WarmSupportGateSemanticContactLoss,
        BICMV119AllNetworkAdaptiveBoundaryLoss,
        BICMV120SameFragmentAffinityLoss,
        BICMV122WarmEdgeProductPrecisionLoss,
        BICMV123HighRecallGateCleanupLoss,
        BICMV124SupportConditionedEdgePrecisionLoss,
        BICMV125SaturatedEdgeDenseGateLoss,
        BICMV126LocalAdjacencyProductLoss,
        BICMV128SupportBridgeSuppressionLoss,
        BICMV129AffinitySharpeningLoss,
        BICMV130SupportTopologyRepairLoss,
        BICMV142SupportTopologyCoreSeedLoss,
        BICMV144StrongCoreSeedLoss,
        BICMV146FragmentSeedPresenceLoss,
        BICMV148CoreHeatmapSeedLoss,
        BICMV150CoreOnlyHeatmapSeedLoss,
        BICMV158CoreOnlyCenterSeedAffinityLoss,
        BICMV159CoreHeatmapCenterSeedAffinityLoss,
        BICMV160CoreOnlyCenterSeedOffsetLoss,
        BICMV161CoreHeatmapCenterSeedOffsetLoss,
        BICMV132SupportVetoGateLoss,
        BICMV133SupportVetoSemanticLoss,
        BICMV6FactorizedLoss,
        BICMV250OracleAlignedDirectLoss,
        BICMV7ContactBalancedLoss,
        BICMV7ContactRankedLoss,
        BICMV7ContactPresenceLoss,
        BICMV7ContactRatioLoss,
        BICMV7ContactDenseRidgeLoss,
        BICMV8ContactContourLoss,
        BICMV9ContactEnergyPairLoss,
        BICMV9ContactEnergyPrecisionLoss,
        BICMV10AdaptiveContactTopologyLoss,
        BICMV12PersistentContactLoss,
        BICMV13PersistentPrecisionLoss,
        BICMV14StagedContactCurriculumLoss,
        BICMV15ContactPresenceGateLoss,
        BICMV16ROIPresenceClassifierLoss,
        BICMV19ROICalibratedPresenceLoss,
        BICMV22CoreMarkerSeparationLoss,
        BICMV23StagedCoreMarkerLoss,
        BICMV24ContactPreservedCoreMarkerLoss,
        BICMV25CoupledContactCoreMarkerLoss,
        BICMV26ContactTolerantPrecisionLoss,
        BICMV28IsolatedContactPrecisionLoss,
        BICMV29GentleIsolatedContactPrecisionLoss,
        BICMV30SoftContactRidgeLoss,
        BICMV31LocalContrastiveContactLoss,
        BICMV32MemoryEfficientLocalContrastLoss,
        BICMV34CompactCoreMarkerLoss,
        BICMV35ContactPrecisionCompactCoreLoss,
        BICMV36StagedContactPrecisionCompactCoreLoss,
        BICMV37AsymmetricContactCompactCoreLoss,
        BICMV38EdgeAffinityLoss,
        BICMV39EdgePrimaryLoss,
        BICMV40EdgePrimaryCoreSeparationLoss,
        BICMV43EdgeContactViabilityLoss,
        BICMV44EdgeLocalRankLoss,
        BICMV46StagedEdgeContactLoss,
        BICMV47SeparatedContactHeadLoss,
        BICMV51DenseEdgeCostLoss,
        BICMV52DenseEdgeCoreTopologyLoss,
        BICMV54SparseHeadBalancedLoss,
        BICMV55CalibratedSparseHeadLoss,
        BICMV56PhasedMarkerContactLoss,
        BICMV58HeatmapMarkerContactLoss,
        BICMV59CorePreservingContactLoss,
        BICMV60StrictCoreTopologyLoss,
        BICMV61PeakSeedLoss,
        BICMV6PrecisionLoss,
        BICMV6SupportCoreLoss,
        BICMV6SupportPrecisionLoss,
        BICMV6SupportSurfaceLoss,
        FactorizedInstanceV4Loss,
        FactorizedInstanceV4SeedFitLoss,
        FactorizedInstanceV4StagedLoss,
        FactorizedInstanceV4SupportFocusLoss,
        LegacyTopologyLoss3D,
        LegacyTopologyExclusiveLoss3D,
        ContactEnergyLoss3D,
        ContactFuseLoss3D,
        DC_CE_BD_loss,
        DC_CE_TV_BD_loss,
...
class PengwinTrainerBoundaryFragmentV3(_GroupedSplitMixin, nnUNetTrainer):
    ...
    def _build_loss(self):
        ...
        if profile in (
            ...
            loss_cls = {
                "boundary_fragment_v3_core_seed": BoundaryFragmentV3CoreSeedLoss,
                "boundary_fragment_v3_core_ridge": BoundaryFragmentV3CoreRidgeLoss,
                "boundary_fragment_v3_core_ridge_recall": BoundaryFragmentV3CoreRecallRidgeLoss,
                "boundary_fragment_v3_core_ridge_recall_masscap": BoundaryFragmentV3CoreRecallRidgeMassCapLoss,
                "boundary_fragment_v3_core_ridge_recall_pos_masscap": BoundaryFragmentV3CoreRecallRidgePositiveMassCapLoss,
                "boundary_fragment_v3_core_ridge_recall_soft_pos_masscap": BoundaryFragmentV3CoreRecallRidgeSoftPositiveMassCapLoss,
                "boundary_fragment_v3_core_ridge_recall_very_soft_pos_masscap": BoundaryFragmentV3CoreRecallRidgeVerySoftPositiveMassCapLoss,
                "boundary_fragment_v3_core_ridge_recall_logit_calibrated": BoundaryFragmentV3CoreRecallRidgeLogitCalibratedLoss,
                "boundary_fragment_v3_core_ridge_recall_precision_logit_calibrated": BoundaryFragmentV3CoreRecallRidgePrecisionLogitCalibratedLoss,
                "boundary_fragment_v3_core_ridge_recall_shell_contrast_logit_calibrated": BoundaryFragmentV3CoreRecallRidgeShellContrastLogitCalibratedLoss,
                "boundary_fragment_v3_core_ridge_recall_strong_shell_contrast_logit_calibrated": BoundaryFragmentV3CoreRecallRidgeStrongShellContrastLogitCalibratedLoss,
                "boundary_fragment_v3_core_ridge_recall_binary_barrier_head": BoundaryFragmentV3CoreRecallRidgeBinaryBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_precision_binary_barrier_head": BoundaryFragmentV3CoreRecallRidgePrecisionBinaryBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_positive_floor_binary_barrier_head": BoundaryFragmentV3CoreRecallRidgePositiveFloorBinaryBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_positive_floor_masscap_binary_barrier_head": BoundaryFragmentV3CoreRecallRidgePositiveFloorMassCapBinaryBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_candidate_binary_barrier_head": BoundaryFragmentV3CoreRecallRidgeCandidateBinaryBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_candidate_masscap_binary_barrier_head": BoundaryFragmentV3CoreRecallRidgeCandidateMassCapBinaryBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_candidate_logit_ridge_barrier_head": BoundaryFragmentV3CoreRecallRidgeCandidateLogitRidgeBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_candidate_logit_ridge_precision_barrier_head": BoundaryFragmentV3CoreRecallRidgeCandidateLogitRidgePrecisionBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_candidate_soft_ridge_barrier_head": BoundaryFragmentV3CoreRecallRidgeCandidateSoftRidgeBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_candidate_soft_ridge_contrast_barrier_head": BoundaryFragmentV3CoreRecallRidgeCandidateSoftRidgeContrastBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_binary_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateBinaryBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_barrier_contrast_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateBarrierContrastHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_seed_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateSeedHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_sparse_seed_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateSparseSeedHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core_compact_seed_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreCompactSeedHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core_compact_sparse_seed_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreCompactSparseSeedHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core_recall_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreRecallBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core_coverage_open_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreCoverageOpenBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core_coverage_guarded_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCoreCoverageGuardedBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_balanced_contact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateBalancedContactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_fragment_peak_core_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateFragmentPeakCoreBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_weak_peak_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025WeakPeakCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_strong_peak_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_mid_peak_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025MidPeakCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_strong_peak_balanced_contact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakBalancedContactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_strong_peak_tight_balanced_contact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakTightBalancedContactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_strong_peak_soft_contact_ridge_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakSoftContactRidgeBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_strong_peak_precision_soft_contact_ridge_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakPrecisionSoftContactRidgeBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_strong_peak_contact_shell_contrast_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakContactShellContrastBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_strong_peak_strong_contact_shell_contrast_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025StrongPeakStrongContactShellContrastBarrierHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_decoder_contact_head": BoundaryFragmentV3Core025StrongPeakDecoderContactHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_xyz_affinity_head": BoundaryFragmentV3Core025StrongPeakXYZAffinityHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_affinity13_seed_healed_head": BoundaryFragmentV3Core025StrongPeakAffinity13SeedHealedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_affinity13_contact_hard_negative_seed_healed_head": BoundaryFragmentV3Core025StrongPeakAffinity13ContactHardNegativeSeedHealedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_mutex13_seed_healed_head": BoundaryFragmentV3Core025StrongPeakMutex13SeedHealedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_mutex13_support_leak_guard_seed_healed_head": BoundaryFragmentV3Core025StrongPeakMutex13SupportLeakGuardSeedHealedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_mutex13_seed_stable_support_leak_guard_seed_healed_head": BoundaryFragmentV3Core025StrongPeakMutex13SeedStableSupportLeakGuardSeedHealedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_mutex13_seed_peak_support_leak_guard_seed_healed_head": BoundaryFragmentV3Core025StrongPeakMutex13SeedPeakSupportLeakGuardSeedHealedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_mutex13_seed_peak_body_support_leak_guard_seed_healed_head": BoundaryFragmentV3Core025StrongPeakMutex13SeedPeakBodySupportLeakGuardSeedHealedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_mutex13_fracture_seed_calibrated_support_leak_guard_seed_healed_head": BoundaryFragmentV3Core025StrongPeakMutex13FractureSeedCalibratedSupportLeakGuardSeedHealedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_pairwise_softmax_mutex13_seed_healed_head": BoundaryFragmentV3Core025StrongPeakPairwiseSoftmaxMutex13SeedHealedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_pairwise_softmax_mutex13_seed_healed_head": BoundaryFragmentV3Core025StrongPeakNoContactPairwiseSoftmaxMutex13SeedHealedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_pairwise_softmax_seed_healed_v273_head": BoundaryFragmentV3Core025StrongPeakNoContactPairwiseSoftmaxSeedHealedV273HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_pairwise_softmax_seed_calibrated_v274_head": BoundaryFragmentV3Core025StrongPeakNoContactPairwiseSoftmaxSeedCalibratedV274HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_global_coord_pairwise_v284_head": BoundaryFragmentV3Core025StrongPeakNoContactPairwiseSoftmaxSeedHealedV273HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_fragment_position_v275_head": BoundaryFragmentV3Core025StrongPeakNoContactFragmentPositionV275HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_fragment_position_dice_v276_head": BoundaryFragmentV3Core025StrongPeakNoContactFragmentPositionDiceV276HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_separator_gap_v277_head": BoundaryFragmentV3Core025StrongPeakNoContactSeparatorGapV277HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_separator_energy_v278_head": BoundaryFragmentV3Core025StrongPeakNoContactSeparatorEnergyV278HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_separator_softmax_v287_head": BoundaryFragmentV3Core025StrongPeakNoContactSeparatorSoftmaxV287HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_abbc_v288_head": BoundaryFragmentV3Core025StrongPeakNoContactABBCV288HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_abbc_sdf_v289_head": BoundaryFragmentV3Core025StrongPeakNoContactABBCSDFV289HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_abbc_sdf_fdm_v290_head": BoundaryFragmentV3Core025StrongPeakNoContactABBCSDFFDMV290HeadLoss,
                ...
                "boundary_fragment_v3_core025_strong_peak_center_flow_head": BoundaryFragmentV3Core025StrongPeakCenterFlowHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_center_peak_flow_head": BoundaryFragmentV3Core025StrongPeakCenterPeakFlowHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_center_peak_flow_calibrated_head": BoundaryFragmentV3Core025StrongPeakCenterPeakFlowCalibratedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_dense_center_heatmap_flow_calibrated_head": BoundaryFragmentV3Core025StrongPeakDenseCenterHeatmapFlowCalibratedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_topology_constrained_center_heatmap_flow_calibrated_head": BoundaryFragmentV3Core025StrongPeakTopologyConstrainedCenterHeatmapFlowCalibratedHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_center_heatmap_flow_head": BoundaryFragmentV3Core025StrongPeakNoContactCenterHeatmapFlowHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_spatial_embedding_head": BoundaryFragmentV3Core025StrongPeakNoContactSpatialEmbeddingHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_spatial_embedding_contrastive_head": BoundaryFragmentV3Core025StrongPeakNoContactSpatialEmbeddingContrastiveHeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_coord_spatial_embedding_v279_head": BoundaryFragmentV3Core025StrongPeakNoContactCoordSpatialEmbeddingV279HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_query_mask_v280_head": BoundaryFragmentV3Core025StrongPeakNoContactQueryMaskV280HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_query_mask_pn_v281_head": BoundaryFragmentV3Core025StrongPeakNoContactQueryMaskV280HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_global_coord_query_mask_v285_head": BoundaryFragmentV3Core025StrongPeakNoContactQueryMaskV280HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_global_coord_query_mask_pn_v286_head": BoundaryFragmentV3Core025StrongPeakNoContactQueryMaskV280HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_free_embedding_v282_head": BoundaryFragmentV3Core025StrongPeakNoContactFreeEmbeddingV282HeadLoss,
                "boundary_fragment_v3_core025_strong_peak_no_contact_global_coord_free_embedding_v283_head": BoundaryFragmentV3Core025StrongPeakNoContactFreeEmbeddingV282HeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_contact_preserve_peak_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025ContactPreservePeakCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_mid_peak_coverage_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025MidPeakCoverageCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_original_contact_mid_peak_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025OriginalContactMidPeakCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_mid_peak_contact_cap_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025MidPeakContactCapCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_mid_peak_tight_contact_cap_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025MidPeakTightContactCapCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_mid_peak_support_seed_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025MidPeakSupportSeedCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_core025_mid_peak_conservative_coretail_compact_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateCore025MidPeakConservativeCoreTailCompactBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_weak_fragment_mass_core_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateWeakFragmentMassCoreBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_loose_fragment_mass_core_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateLooseFragmentMassCoreBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_instance_core_guard_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateInstanceCoreGuardBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_instance_core_strong_guard_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateInstanceCoreStrongGuardBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_masscap_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateMassCapBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_dense_candidate_weak_masscap_barrier_head": BoundaryFragmentV3CoreRecallRidgeDenseCandidateWeakMassCapBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_soft_dense_candidate_barrier_head": BoundaryFragmentV3CoreRecallRidgeSoftDenseCandidateBarrierHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_soft_dense_candidate_barrier_contrast_head": BoundaryFragmentV3CoreRecallRidgeSoftDenseCandidateBarrierContrastHeadLoss,
                "boundary_fragment_v3_core_ridge_recall_masscap_tight": BoundaryFragmentV3CoreRecallRidgeTightMassCapLoss,
            }[profile]
            loss = loss_cls(base)
            if self._do_i_compile():
        ...
        if profile in ("boundary_fragment_v3_ridgefit", "boundary_fragment_v3_ridgefit_precision"):
            loss_cls = (
                BoundaryFragmentV3RidgeFitPrecisionLoss
                if profile == "boundary_fragment_v3_ridgefit_precision"
                else BoundaryFragmentV3RidgeFitLoss
            )
            loss = loss_cls(base, fullres_ridge_terms=True)
            if self._do_i_compile():
                base.dc = torch.compile(base.dc)
            if self.enable_deep_supervision:
                aux_base = _base_loss()
                if self._do_i_compile():
                    aux_base.dc = torch.compile(aux_base.dc)
                aux_loss = loss_cls(aux_base, fullres_ridge_terms=False)
                ds_scales = self._get_deep_supervision_scales()
                weights = np.array([1.0 / (2 ** i) for i in range(len(ds_scales))])
                weights[-1] = 1e-6 if self.is_ddp and not self._do_i_compile() else 0.0
                weights = weights / weights.sum()
            ...
            if profile == "boundary_fragment_v3_ridgefit_precision":
                self.print_to_log_file(
                    "[BoundaryFragmentV3] Loss = RidgeFit precision-phase fullres class2 objective "
                    "(hard class2 CE + balanced focal + precision-Tversky + positive/negative margins "
                    "+ all-nonclass2 top-k hard negatives); low-res DS uses base/support only"
                )
            else:
                self.print_to_log_file(
                    "[BoundaryFragmentV3] Loss = RidgeFit fullres class2 objective "
                    "(hard class2 CE + focal + recall-Tversky + margin + top-k hard negatives); "
                    "low-res DS uses base/support only"
                )
            return loss
